  ...
  return (
    <main className="flex flex-col mx-auto max-w-7xl w-screen my-20 space-y-20 min-h-screen">
      ...
      <div className="prose prose-stone mx-auto max-w-7xl gap-10 grid grid-cols-1 md:grid-cols-2">
        ...
        >
          <h1>
            Split <Square2StackIcon className="w-8 h-8 inline-block" />
          </h1>
          <p>
        ...
        >
          <h1>
            Stamp <BookmarkIcon className="w-8 h-8 inline-block" />
          </h1>
          <p>Creates text watermark stamps to your PDF documents.</p>
        </Link>
        <Link
          to="/"
          className="no-underline bg-stone-100 w-72 lg:w-96 rounded-xl py-5 px-7 hover:bg-stone-200"
        >
          <h1>
            Convert <ArrowsRightLeftIcon className="w-8 h-8 inline-block" />
          </h1>
          <p>Converts a file into PDF or any PDF file to another file type.</p>
        </Link>
      </div>
